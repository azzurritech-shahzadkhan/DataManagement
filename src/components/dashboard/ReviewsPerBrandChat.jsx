...
const chartData = [
  ...
  { month: "Brand 8", desktop: 73 },
  { month: "Brand 9", desktop: 209 },
  { month: "Brand 10", desktop: 214 },
];

// Array of colors for each bar
const barColors = [
  "#4F46E5", "#FF6347", "#32CD32", "#FFD700", "#8A2BE2", "#FF4500","#FFD700","#FF6347","#FFD700","#4F46E5"
];

export function ReviewsPerBrandChat() {
  return (
    <div className="p-6 rounded-lg bg-white shadow text-white chart w-full overflow-hidden ">
      <div className="mb-4">
        <h2 className="text-lg font-semibold">Reviews per brand</h2>
      </div>
