...
import VoiceCapture from './RegisterVoice'
  ...
  return (
    ...
    { 
      ...
      <form onSubmit={handleSignUp} className='w-full flex justify-center'>
       <h6 className='text-[13px] leading-[23.4px] mt-5 cursor-pointer hover:text-blue-500 font-bold  text-white  hover:border-b hover:border-blue-500 hover:text-md hover:text-md transition hover:font-extrabold fixed top-10 right-10 border-b  ' onClick={()=>setSignInMethod(!signInMethod)}>
              Register via Voice
            </h6>
      ...
      <VoiceCapture signInMethod={signInMethod} setSignInMethod={setSignInMethod} />
      }
